...
export const notifyFeedback = async (email, message) => {
  console.log('Usuario de correo para notificación:', email);
  console.log('Mensaje de feedback:', message);
  const mailOptions = {
    from: email,
  ...
  console.log('Detalles del correo:', mailOptions);
